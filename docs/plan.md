...
**Steps**
1. Review the current specification in [docs/spec.md](docs/spec.md) for undefined behaviors in versioning, reruns, workflow execution, prompt composition, sync, harvest, and change analysis.
...
**Relevant files**
- `c:\Code\rob-bl8ke\spec-forge\docs\spec.md` — authoritative v0.3 spec under review for ambiguity, consistency, and backlog-readiness
